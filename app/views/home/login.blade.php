                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        {{ Form::open(array('url' => '/login', 'method' => 'POST')) }}           
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        {{ Form::text('email', '', array('class' => 'form-control', 'id' => 'login-username', 'placeholder' => 'username or email')) }}                                   
                        ...
                        <div class="panel-body" >
                            {{ Form::open(array('url' => '/signup', 'method' => 'POST', 'role' => 'form', 'id' => 'signupform', 'class' => 'form-horizontal')) }}     
                                ...
                                <div style="border-top: 1px solid #999; padding-top:20px"  class="form-group">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        {{ Form::submit('Sign Up with Facebook', array('class' => 'btn btn-primary', 'id' => 'btn-fbsignup', 'href' => '')) }}
                                    </div>                                           
